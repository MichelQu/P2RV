...
// Ce script place le nom du QR Code sélectionné dans une zone de Texte.
...
public class NomObjet : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        selectedName = PlayerPrefs.GetString("QRName");
        zoneText.text = "Code sélectionné : " + selectedName;
    }
}
